...
const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    id: '11',
    category: 'عام',
    question: 'هل مواد البرمجة والتاريخ المصري تضاف إلى المجموع النهائي؟',
    answer: 'لا، مواد البرمجة والتاريخ المصري (في السنة التمهيدية) لا تضاف إلى المجموع النهائي، بل هي مواد نجاح ورسوب فقط (مع ضرورة تحقيق نسبة 70% على الأقل لاجتياز مادة البرمجة والمواد غير المضافة للمجموع).'
  }
];
