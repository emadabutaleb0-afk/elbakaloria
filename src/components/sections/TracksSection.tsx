...
const TRACKS = [
  {
    ...
    grade2: ['التربية الدينية', 'الأحياء', 'الكيمياء', 'اللغة الإنجليزية'],
    grade3: ['التربية الدينية', 'الأحياء (مستوى رفيع)', 'الكيمياء'],
  ...
  },
  {
    ...
    grade2: ['التربية الدينية', 'الرياضيات', 'الفيزياء', 'اللغة الإنجليزية'],
    grade3: ['التربية الدينية', 'الرياضيات (مستوى رفيع)', 'الفيزياء'],
  ...
  },
  {
    ...
    grade2: ['التربية الدينية', 'الرياضيات', 'الاقتصاد', 'اللغة الإنجليزية'],
    grade3: ['التربية الدينية', 'اقتصاد (مستوى رفيع)', 'الرياضيات'],
  ...
  },
  {
    ...
    grade2: ['التربية الدينية', 'اللغة العربية', 'اللغة الإنجليزية', 'التاريخ'],
    grade3: ['التربية الدينية', 'جغرافيا (مستوى رفيع)', 'الإحصاء'],
      ...
      <div className="container mx-auto">
        ...
        <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 p-6 md:p-8 animate-fade-in-up">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              <h4 className={`font-bold text-lg mb-4 ${track.textColor} ${track.darkTextColor}`}>مقررات الصف الثاني (٤ مواد)</h4>
            ...
            <div>
              <h4 className={`font-bold text-lg mb-4 ${track.textColor} ${track.darkTextColor}`}>مقررات الصف الثالث (٣ مواد)</h4>
              <ul className="space-y-3">
