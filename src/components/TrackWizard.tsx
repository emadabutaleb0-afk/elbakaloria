            ...
            <div className="border-t border-slate-200 dark:border-slate-700 pt-6 mt-6">
              ...
              <div className="mb-4">
                <button
                  ...
                  className="w-full px-4 py-3 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 rounded-lg font-semibold hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isPdfLoading ? (
                    <>
